...
export const getMessages = async (req, res) => {
  try {
    ...
    }).populate("messages"); //instead of giving msg id, it will give us message obj array bcoz of populate method
    ...
    console.log("Error in sent getmessages controller : ", error.message);
    return res.status(500).json({ error: "Internal Server Error" });
  }
};
